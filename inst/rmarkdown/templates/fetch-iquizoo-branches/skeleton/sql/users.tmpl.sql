...
FROM
	...
	INNER JOIN iquizoo_content_db.project_course_config ON project_course_config.Id = project_course_user.ProjectCourseConfigId -- `project_course_config` might be used in "where_clause"
