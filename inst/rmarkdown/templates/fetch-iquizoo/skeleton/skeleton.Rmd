...
list(
  ...
  tar_target(scores, tarflow.iquizoo::pickup(query_tmpl_scores, config_where))
)
```
...
list(
  ...
  tar_target(data, tarflow.iquizoo::pickup(query_tmpl_data, config_where))
)
```
